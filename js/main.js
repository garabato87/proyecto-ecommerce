...
const mostrarProductos = (productos) => {
    ...
    productos.forEach((elm) => {
        const div = document.createElement("div");
        div.classList.add("producto");
        div.classList.add("flip-in-diag-2-br")
        div.innerHTML = `
            <img class="flip-in-diag-2-br" src="${elm.img}">
            <hr>
            <h5>${elm.nombre}</h5>
        ...
        div.getElementsByTagName("button")[0].addEventListener("click", () => agregarAlCarrito(elm));
    });
